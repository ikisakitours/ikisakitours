          ...
          (review) =>
            review.isPubliclyVisible && (
              <div key={review.id} className="bg-white border rounded-xl p-5 shadow-sm hover:shadow-md transition">
                  ...
                  <div className="flex items-center gap-3">
                      ...
                      {review.avatarUrl ? (
                        ...
                        <span className="text-gray-500 font-bold text-sm">
                          {review.firstName && review.lastName
                            ? `${review.firstName.charAt(0)}${review.lastName.charAt(0)}`.toUpperCase()
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 flex items-center gap-1">
                        ...
                        {/* Verified Badge */}
                        {review.isVerified && (
                          <span className="text-blue-500 text-sm" title="Verified User">
                            ✔
                          </span>
                        )}
                        {/* VIP Badge */}
                        {review.isVip && (
                          <span className="bg-yellow-400 text-white text-[10px] px-1 rounded ml-1">VIP</span>
                        )}
                      </h4>
                ...
                {/* Content */}
                <p className="text-gray-700 text-sm mb-4 line-clamp-4">&quot;{review.content}&quot;</p>
