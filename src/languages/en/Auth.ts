export default {
  "Metadata": {
    "Signup": {
      ...
      "description": "Create a MapMate member account for private travel planning, exclusive tour bookings, and personalized Sri Lankan itineraries."
    },
  ...
  "Social": {
    "signupLabel": "Social Sign Up",
    "loginLabel": "or continue with"
  },
  "Links": {
    "alreadyHaveAccount": "Already have an account?",
    "signInHere": "Sign In Here",
    "firstTime": "First time visiting?",
    "createAccount": "Create Account",
    "forgotPassword": "Forgot password?",
    "rememberIt": "Wait, I remember it!",
