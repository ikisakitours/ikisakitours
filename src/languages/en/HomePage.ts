export default {
  ...
  Services: {
    ...
    PrivateVehicle: {
      ...
      appText: "Direct WhatsApp & Line",
      appDefaultText: "Hello! I would like to inquire about your private vehicle services.",
      imagesAlt: {
