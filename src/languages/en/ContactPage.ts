export default {
  ...
  "IntroCard": {
    ...
    "description": "Send your travel dates, group size, interests, and questions. We can help with custom itineraries, transport, day tours, accommodation ideas, ticketing, and visa support.",
    "slides": [
      {
        "image": "https://images.unsplash.com/photo-1519046904884-53103b34b206?q=95&w=1600&auto=format&fit=crop",
  ...
  "Sidebar": {
    "title": "Contact Info",
   "messagesAppTitle": "Prefer WhatsApp or LINE?", 
  ...
  "Form": {
    ...
    "tourOptions": ["Multi-Day Tour", "One-Day Tour", "Honeymoon Package", "Wildlife Safari"]
  },
  "Features": [
    {
