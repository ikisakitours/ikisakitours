export default {
  ...
  description:
    "Use it on any of our luxury multi-day tours before the end of the month. Discount will appear at checkout automatically when you activate it now. Valid on orders over $200.",
