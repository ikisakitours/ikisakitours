export default {
  ...
  "Hero": {
    ...
    "description": "Real stories from real travelers. Discover why the world's most discerning explorers choose LankaElite for their Sri Lankan odyssey.",
    "stats": {
      "success": "Success",
      "support": "Support",
      "reviews": "Reviews",
  ...
  "FormHero": {
    ...
    "title1": "Inspire the next",
    "titleHighlight": "Generation",
    "title2": "of explorers.",
    "description": "Your feedback is the compass that guides our future journeys. Tell us about the moments that took your breath away.",
