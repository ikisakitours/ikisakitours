export default {
  ...
  "EmptyState": {
    ...
    "descSearchAndCategory": "「{category}」カテゴリーに「{query}」に一致する質問は見つかりませんでした。フィルターをクリアするか、別のキーワードをお試しください。",
    "descSearchOnly": "「{query}」に一致する質問は見つかりませんでした。フィルターをクリアするか、別のキーワードをお試しください。",
