export default {
  "Metadata": {
    "title": "Neem contact met ons op - Neem contact met ons op",
    "description": "Neem contact op met MapMate voor vragen, hulp bij het plannen van excursies of ondersteuning met betrekking tot uw reis naar Sri Lanka."
  },
  "Hero": {
    "eyebrow": "Begin een gesprek",
    "title": "Een betere reis begint met een duidelijke eerste boodschap",
    "accent": "eerste bericht",
    "strapline": "Stuur uw reisdata, groepsgrootte, interesses en vragen.",
    "image": "https://images.unsplash.com/photo-1519046904884-53103b34b206?q=95&w=1600&auto=format&fit=crop",
    "altText": "Sri Lankaanse zonsondergang"
  },
  "IntroCard": {
    "badge": "✨Ga een gesprek aan",
    "titleMain": "Een betere reis begint met een",
    "titleBreak": "duidelijk eerste bericht",
    "description": "Stuur uw reisdata, groepsgrootte, interesses en vragen. We kunnen u helpen met aangepaste reisroutes, vervoer, dagtochten, accommodatie-ideeën, ticketverkoop en visumondersteuning.",
    "slides": [
      {
        "image": "https://images.unsplash.com/photo-1519046904884-53103b34b206?q=95&w=1600&auto=format&fit=crop",
  ...
  "Sidebar": {
    ...
    "messagesAppTitle": "Liever WhatsApp of LINE?",
