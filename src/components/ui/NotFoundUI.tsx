    ...
    <div className="relative flex min-h-[90vh] w-full flex-col items-center justify-center px-6 overflow-hidden bg-lanka-dark py-12">
      ...
      <div className="relative flex w-full max-w-2xl flex-col items-center text-center z-10">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-gold/10 border border-gold/30 text-gold text-[11px] font-black uppercase tracking-[0.3em] mb-10 shadow-[0_0_30px_rgba(197,160,89,0.2)] backdrop-blur-md"
        >
        ...
        <motion.p
          ...
          className="relative z-10 mb-12 text-base sm:text-lg font-light leading-relaxed text-slate-400 max-w-lg"
        >
          {description}
        </motion.p>
