  ...
  return (
    ...
    >
      <Image
        ...
        className="image-render-visible object-cover grayscale-50 transition-all duration-700 group-hover:scale-110 group-hover:grayscale-0 group-focus-visible:scale-110 group-focus-visible:grayscale-0"
      />
