...
export default function TourCustomization() {
  ...
  return (
    <section
      ...
      className="glass-card mb-8 rounded-4xl border border-white/5 p-6 md:mb-10 md:p-8"
    >
      <div className="flex items-center gap-4 md:gap-6 mb-4">
        ...
        <h3 className="text-heading-card font-bold text-white md:text-xl leading-none">
          {t("title")}
        </h3>
      </div>
      
      <p className="text-body leading-[1.7] text-slate-300 text-left w-full">
        {t("description")}
      </p>
    </section>
  );
