        ...
        {valuesArray.map((value, index) => {
          ...
          return (
            ...
            >
              ...
              <h4 className="text-white text-body-lead font-bold tracking-wide">{value.title}</h4>
              <p className="text-foreground/80 text-body leading-relaxed">{value.description}</p>
            </div>
          );
        })}
      </div>
